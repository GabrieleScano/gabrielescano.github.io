 ...
 *
 * Mirrored from the `requirements-analyzer` repository (src/core/rules.ts).
 * Pure functions, no dependencies — which is exactly why the same engine can
 * run client-side in the live demo.
 */
