 ...
 *
 * Mirrored from the `requirements-analyzer` repository (src/core/types.ts)
 * so the live demo runs the exact same engine as the CLI. Only the relative
 * import extensions differ (the repo emits NodeNext ESM, Vite resolves
 * extensionless paths).
 */
